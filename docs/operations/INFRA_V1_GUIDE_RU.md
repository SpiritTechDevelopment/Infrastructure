...
Управляющие интерфейсы наблюдаемости не следует открывать наружу. Операторский
доступ выполняется через управляющую сеть и локальный SSH tunnel с портами из
применённого контракта, без копирования адресов в документацию.
